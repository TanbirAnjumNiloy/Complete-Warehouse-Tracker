...
class GramSetup(models.Model):
    ...
    grams = models.FloatField()  # The grams you want to set
    current_grams = models.FloatField()  # The current amount of grams
    
    
class Minmaxsetup(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='min_max_setup')
    minvalue = models.IntegerField(null=True, blank=True) 
    maxvalue = models.IntegerField(null=True, blank=True)  
    
class CartonSetup(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='carton_setups')
